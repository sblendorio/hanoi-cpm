...
{0}   _BLACK = #27#27#27#32;
{1}   _WHITE = #27#27#27#33;
{2}   _RED = #27#27#27#34;
{3}   _CYAN = #27#27#27#35;
{4}   _PURPLE = #27#27#27#36;
{5}   _GREEN = #27#27#27#37;
{6}   _BLUE = #27#27#27#38;
{7}   _YELLOW = #27#27#27#39;
{8}   _DARKPURPLE = #27#27#27#40;
{9}   _BROWN = #27#27#27#41;
{10}  _LIGHTRED = #27#27#27#42;
{11}  _DARKGREY = #27#27#27#43;
{12}  _MIDGREY = #27#27#27#44;
{13}  _LIGHTGREEN = #27#27#27#45;
{14}  _LIGHTBLUE = #27#27#27#46;
{15}  _LIGHTGREY = #27#27#27#47;
...
begin
  ...
  gotoxy(wd,24); write(s,_BLINK,'_',_PLAIN);
end;
...
begin
  ...
  gotoxy(29,14); write(_PLAIN,_CYAN,'by Francesco Sblendorio');
end;
...
begin
  ...
  center(12,_PLAIN+_WHITE,'(C) 1996 MS-DOS version     (C) 2015 CP/M version');
  write(_PLAIN);
  read(kbd,c);
end;
...
begin
  hidecursor;
  backgroundcolor(lt_grey); write(_PLAIN);
  initialize;
  repeat
